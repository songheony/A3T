...
baselinegood=("MCCT_Good" "Random_Good" "Max_Good")
...
baselinerbad=("MCCT_Bad" "Random_Bad" "Max_Bad")
...
baselinermix=("MCCT_Mix" "Random_Mix" "Max_Mix")
...
baselinedw=("MCCT_SiamDW" "Random_SiamDW" "Max_SiamDW")
...
baselinerpn=("MCCT_SiamRPN++" "Random_SiamRPN++" "Max_SiamRPN++")
