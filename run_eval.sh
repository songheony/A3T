all_experts=("DaSiamRPN" "SiamDW" "SiamRPN" "SPM" "THOR" "GradNet" "Ocean" "SiamBAN" "SiamCAR" "SiamFC++" "SiamRPN++" "Staple" "ATOM" "DiMP-50" "DROL" "KYS" "PrDiMP-50" "RLS-RTMDNet" "SiamMCF")
python ./visualize_eval.py -e ${all_experts[@]} -d Expert
