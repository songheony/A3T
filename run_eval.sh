...
high_baseline=("MCCT_High_0.10" "Random_High" "Max_High")
...
low_baseline=("MCCT_Low_0.10" "Random_Low" "Max_Low")
...
mix_baseline=("MCCT_Mix_0.10" "Random_Mix" "Max_Mix")
...
siamdw_baseline=("MCCT_SiamDW_0.10" "Random_SiamDW" "Max_SiamDW")
...
siamrpn_baseline=("MCCT_SiamRPN++_0.10" "Random_SiamRPN++" "Max_SiamRPN++")
