...
from external.toolkit.got10k.datasets import UAV123
from external.toolkit.got10k.utils.metrics import rect_iou, center_error
...
class ExperimentUAV123(ExperimentOTB):
    ...
    def __init__(
        self, root_dir, version="UAV123", result_dir="results", report_dir="reports"
    ):
